...
public class ListaAlumnoIU extends javax.swing.JFrame {
    ...
    public ListaAlumnoIU() {
        initComponents();
    }
    
    public ListaAlumnoIU(RegistroPersona registroPersona){
        initComponents();
        ...
        modeloTabla.addColumn("Cod. Alumno");
        modeloTabla.addColumn("Carrera Profesional");
    ...
    private void moverArregloAModeloTabla(){
        ...
        Persona[] listaAlumnos = this.registroPersona.getListaAlumnos();
        for (int i = 0; i < listaAlumnos.length; i++) {
            Alumno objAlumno = (Alumno)listaAlumnos[i]; // casting para obtener un objeto Alumno
            String[] fila = new String[4];
            fila[0] = String.valueOf(objAlumno.getDni());
            fila[1] = objAlumno.getNombres();
            fila[2] = String.valueOf(objAlumno.getCodAlumno());
            fila[3] = objAlumno.getCp();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaAlumnoIU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaAlumnoIU().setVisible(true);
            }
        });
    }
